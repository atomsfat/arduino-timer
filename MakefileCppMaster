...
ARDUINO_PATH:=/home/bending/java/arduino-0022/
...
CPPDIRS:=*.cpp utility/*.cpp $(addsuffix *.cpp,$(CPPDIRS)) $(shell find $(ARDUINO_PATH)hardware/arduino/cores/arduino/ -type f -name "*.cpp" | grep -v main.cpp) 
...
CPPSRC:=$(addprefix $(TMPDIRPATH),$(PDESRC:.Main.cpp)) $(CPPSRC)
